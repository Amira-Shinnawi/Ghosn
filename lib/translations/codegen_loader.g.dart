...
class CodegenLoader extends AssetLoader {
  ...
  static const Map<String, dynamic> ar = {
    ...
    "reciet":
        "يرجي الاحتفاظ بصورة هذا الايصال عن طريق لقطة شاشة لحين الحاجة اليه عند الاستلام الاوردر لضمان حقوق المستخدم.",
    "paymentsuccess": "تمت عملية الدفع بنجاح",
    "finishorder":
        "تم حجز المنتج المطلوب وسيصل إلي العنوان المحدد في غضون 3 أيام",
