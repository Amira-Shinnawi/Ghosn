...
class RadioListTitleWidget extends StatefulWidget {
  ...
  final String street;
    const RadioListTitleWidget({super.key, required this.selectedPaymentMethod, required this.address, required this.phoneNumber, required this.street});
  @override
         ...
         child: Container(
                ...
                decoration: ShapeDecoration(
                  ...
                  shape: RoundedRectangleBorder(
                    side: BorderSide(width: 2, color: _selectedIndex == 0 ? kGreenColor : const Color(0xFFE5DBDB),),
            ...
            Padding(
              ...
              child: Container(
                ...
                decoration: ShapeDecoration(
                  color: const Color(0xFFFAF6F6),
                  shape: RoundedRectangleBorder(
                    side: BorderSide(width: 2, color: _selectedIndex == 1 ? kGreenColor : const Color(0xFFE5DBDB),),
                    borderRadius: BorderRadius.circular(8),
                  ),
                ),
                child: Row(
