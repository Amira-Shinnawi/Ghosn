...
abstract class Styles {
  static const textStyle22Inter = TextStyle(
    color: Colors.white,
    fontSize: 22,
  ...
  static const textStyle16Inter = TextStyle(
   color: Colors.black,
    fontSize: 16,
    fontFamily: 'Almarai',
   ...
   static const textStyle16Intergreen = TextStyle(
    ...
    fontWeight: FontWeight.bold,
    fontFamily: 'Inter',
    decoration: TextDecoration. underline, decorationColor: kGreenColor,
   ...
   static const textStyle20Interwhite = TextStyle(
   color: Colors.white,
    fontSize: 20,
    fontFamily: 'Almarai',
    fontWeight: FontWeight.w700,
