...
class FollowerCommentPostItem extends StatefulWidget {
  const FollowerCommentPostItem({
    super.key,
    this.onReplay,
  ...
  final CommentsFollower commentModel;
  final PostsFollower post;
  final int commentIndex;
  final void Function()? onReplay;
  final void Function()? onDeleteTap;
  @override
  State<FollowerCommentPostItem> createState() =>
      _FollowerCommentPostItemState();
}

class _FollowerCommentPostItemState extends State<FollowerCommentPostItem> {
  int likeCount = 0;
