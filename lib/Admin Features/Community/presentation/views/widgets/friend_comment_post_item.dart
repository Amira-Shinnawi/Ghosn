...
class FriendCommentPostItem extends StatefulWidget {
  ...
  final CommentsFollowing commentModel;
  final PostsFollowing post;
  final int commentIndex;
  final void Function()? onReplay;
  final void Function()? onDeleteTap;
  @override
  State<FriendCommentPostItem> createState() => _FriendCommentPostItemState();
}

class _FriendCommentPostItemState extends State<FriendCommentPostItem> {
  int likeCount = 0;
