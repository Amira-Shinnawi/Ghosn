...
import 'follower_post_item.dart';
import 'follower_post_view.dart';

class FollowerAddCommentBody extends StatefulWidget {
  const FollowerAddCommentBody({
    super.key,
    required this.userModel,
  });
  final PostsFollower userModel;

  @override
  State<FollowerAddCommentBody> createState() => _FollowerAddCommentBodyState();
}

class _FollowerAddCommentBodyState extends State<FollowerAddCommentBody> {
                ...
                children: [
                  ...
                  ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      PostsFollower comments = widget.userModel;
                      CommentsFollower comment = comments.comments![index];
                      return FollowerCommentPostItem(
                        post: comments,
